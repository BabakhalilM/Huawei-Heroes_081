...
const Cartshow = () => {
  ...
  return (
    <div className="admin-container">
      ...
      <div className='analist'><Text fontSize={25}>Product Count in Cart: {data.length}</Text></div>
      <div className='analist'><Text fontSize={25}>Total Cart Value: {totalcost}</Text></div>
      </Flex>
          ...
          <div className="card-item" key={card.id}>
            ...
            <div className="card-details">
              ...
              <div className="price4-controls">
                <button className='btn' style={{width:"20%"}} onClick={() => handleDecrementPrice4(card.id)}>-</button>
                <span style={{margin:"0px 20px"}}> {card.price4}</span>
                <button className='btn' style={{width:"20%"}} onClick={() => handleIncrementPrice4(card.id)}>+</button>
              </div>
            </div>
