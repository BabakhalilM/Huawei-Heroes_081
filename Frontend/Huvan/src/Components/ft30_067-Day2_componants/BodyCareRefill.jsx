    ...
    <>
      <div className="firstimg">
        <img
          className="fimg"
          style={{height:'70vh'}}
          src="https://haanready.com/cdn/shop/collections/Refill_Body_care.jpg?v=1711041487&width=1920"
          alt=""
        />
        <p
          style={{
      ...
      <div className="app" style={{ marginTop: "390px" }}>
