    ...
    <>
      <div className="firstimg">
        <img
          className="fimg"
          style={{ height: "60vh" }}
          src="https://haanready.com/cdn/shop/collections/Handcare_Packs_19dec758-0177-4c81-9865-0bbbce80f560.jpg?v=1711041428&width=1920"
          alt=""
        />
        <p
          style={{
